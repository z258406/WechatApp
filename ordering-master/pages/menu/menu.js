...
Page({
  ...
  data: {
    ...
    orderlist:{
      maingoods: [
        { text: "黑椒牛肉披萨", mgoods: false }, { text: "焦香蟹柳披萨", mgoods: false }, { text: "培根洋葱披萨", mgoods: false }, { text: "番茄肉酱披萨", mgoods: false }, { text: "焦香虾仁披萨", mgoods: false }, { text: "爆浆榴莲椰椰披萨", mgoods: false }, { text: "超级至尊披萨", mgoods: false }
      ],
      snack: [{ text: "薯角", mgoods: false }, { text: "薯角", mgoods: false }, { text: "疯狂辣翅", mgoods: false }, { text: "洋葱圈", mgoods: false }, { text: "狂暴鸡米花", mgoods: false }, { text: "吮指原味鸡", mgoods: false }, { text: "油炸小排", mgoods: false }]
    }
  },
